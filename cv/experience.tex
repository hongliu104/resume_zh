  ...
  \cventry
    ...
    {2016.11 - 至今} % Date(s)
    {
      \begin{itemize}[parsep=0.2ex] % Description(s) of tasks/responsibilities
        \item \descriptionstyle{带领7人团队研发168X系列深度学习加速芯片的上层软件SDK(提供Python/C++ api), 开源地址: https://github.com/sophon-ai-algo/sophon-inference;}
        \item \descriptionstyle{对CV领域各主流深度学习框架下的主流的分类/检测模型, 在SC5H(17.6T INT8算力，2.2T FP32算力)上进行精度速度测试;}
  ...
  \cventry
    ...
    {2015.12 - 2016.10} % Date(s)
    {
      \begin{itemize}[parsep=0.2ex] % Description(s) of tasks/responsibilities
        ...
        \item \descriptionstyle{百度外卖出餐时间预测，预测用户下单到商户做好菜品的时间，以优化外卖其实的调度方案，平均误差由11分钟降到7分钟;}
